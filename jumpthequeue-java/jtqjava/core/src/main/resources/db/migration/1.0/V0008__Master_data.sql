...
startDate,endDate) VALUES (1, 1, 'Indigo','Banglore','Biggest Color Fest', NULL,2, '5', 'Q001',
'2021-01-01 00:01:00','2021-02-01 00:01:00');
INSERT INTO Event (id, modificationCounter, 
eventName, location, description, logo,visitorCount, attentionTime, currentlyBeingAttended,
startDate,endDate) VALUES (2, 1, 'Food Fest','Banglore','Biggest Food Fest', NULL,0, '5', 'Q001',
'2021-01-01 00:01:00','2021-02-01 00:01:00');
...
idVisitor, idEvent) 
VALUES (1, 1, 'Q001', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP, 1,1);
INSERT INTO QueueDetail (id, modificationCounter, 
queueNumber, creationTime, startTime, endTime, minEstimatedTime, 
idVisitor, idEvent) 
VALUES (2, 1, 'Q002', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, CURRENT_TIMESTAMP, 0,1);